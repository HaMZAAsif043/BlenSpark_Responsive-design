...
const Services = () => {
    ...
    return (
        <div className="container py-12 px-4 cursor-pointer">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-2">
                {ServicesData.map((service, index) => (
                    <div key={index} className="service-card bg-white p-6 flex w-full md:w-1/3 transform transition duration-500 hover:scale-105 relative" onClick={handleOnClick}>
